...
class Retriever:
    ...
    def __init__(self, store: FAISS, top_k: int = _DEFAULT_TOP_K, score_threshold: float = _DEFAULT_SCORE_THRESHOLD):
        if top_k <= 0:
        ...
        LOG.debug("Retriever configured: top_k=%d, score_threshold=%.2f", top_k, score_threshold)
    ...
    def retrieve(self, query: str) -> list[str]:
        ...
        chunks = [doc.page_content for doc, score in results if score >= self._score_threshold]
